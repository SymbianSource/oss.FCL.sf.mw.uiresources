...
void AConvolute64KSharpen( CFbsBitmap& aTarget,
    ...
    ADoConvolute64KSharpen(targetAddr, sourceAddr, combinedScanW, width, height, aBlendFactor);
...
#ifndef ARM_VERSION
__NAKED__ void ADoConvolute64KSharpen( TUint*, TUint*, TInt, TInt, TInt, TInt )
    {
//    return;
#else
__NAKED__ void ADoConvolute64KSharpen( TUint* aBaseT,
                                       TUint* aBaseS,
                                       TInt aCombinedScanW,
                                       TInt aWidth,
                                       TInt aHeight,
