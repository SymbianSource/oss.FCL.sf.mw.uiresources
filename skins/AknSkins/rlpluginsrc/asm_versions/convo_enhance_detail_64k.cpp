...
void AConvolute64KEnhanceDetail( CFbsBitmap& aTarget,
    ...
    ADoConvolute64KEnhanceDetail(targetAddr, sourceAddr, combinedScanW, width, height, aBlendFactor);
...
#ifndef ARM_VERSION
__NAKED__ void ADoConvolute64KEnhanceDetail( TUint*, TUint*, TInt, TInt, TInt, TInt )
    {
//    return;
#else
__NAKED__ void ADoConvolute64KEnhanceDetail( TUint* aBaseT,
                                             TUint* aBaseS,
                                             TInt aCombinedScanW,
                                             TInt aWidth,
                                             TInt aHeight,
...
widthloop
    ...
    AND r8, r12, r7, LSR #16 // r8 = blue-value of a2, b1
    AND r5, r10, r7, LSR #12
    ORR r8, r8, r5           // r8 = green and blue of a2, b1
    AND r5, r11, r7, LSR #8 
    ORR r8, r8, r5           // r8 = red, green and blue of a2, b1
    ...
    ADD r8, r8, r4           // r8 = a2 + a4
    AND r9, r12, r7, LSR #16 // r9 = blue-value of a5, b4
    AND r5, r10, r7, LSR #12
    ORR r9, r9, r5           // r9 = green and blue of a5, b4
    AND r5, r11, r7, LSR #8 
    ORR r9, r9, r5           // r9 = red, green and blue of a5, b4
    ...
    SUB r12, r12, r12, lsr #2   
    ADD r12, r12, r12, lsr #4   
    ADD r12, r12, r12, lsr #8   
    ADD r12, r12, r12, lsr #16  
    MOV r12, r12, lsr #2         // divide convolution sum by 5
