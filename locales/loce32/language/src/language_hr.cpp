...
// Fileserver
    ...
    _S("Ne mogu zavriti upis na disk"),					// Low power - line2
    _S("Greka diska - ne mogu zavriti upis"),				// Disk error - line1
    _S("Pokuajte ponovo ili \x0107"L"e se podaci izgubiti"),  // Disk error - line2
// SoundDriver
