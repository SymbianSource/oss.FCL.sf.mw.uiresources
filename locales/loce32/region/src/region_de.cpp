...
* Contributors:
*
* Description:   elocl_reg.276 for Germany region
*
*/
...
const TText* const RegionAspect::ShortDateFormatSpec = _S("%F%/0%*D%/1%*M%/2%*Y%/3"); // day.month.year (with leading zeros, year with 2 digits)
