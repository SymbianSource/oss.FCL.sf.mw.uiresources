...
* Contributors:
*
* Description:   elocl_reg.620 for Portugal region
*
*/
...
const TInt RegionAspect::CountryCode = 351;
...
const TText* const RegionAspect::TimeFormatSpec = _S("%F%:0%*H%:1%*T%:2%*S%:3"); // hours:minutes:seconds (without leading zeros)
...
const TUint16 RegionAspect::RegionCode = 620;	
