...
* Contributors:
*
* Description:   elocl_reg.76 for Brazil region
*
*/
...
const TInt RegionAspect::CountryCode = 55;
const TInt RegionAspect::UniversalTimeOffset = -10800;
...
const TText * const RegionAspect::CurrencySymbol = _S("R$");
const TText* const RegionAspect::ShortDateFormatSpec = _S("%F%/0%D%/1%M%/2%*Y%/3"); // day/month/year 
const TText* const RegionAspect::LongDateFormatSpec = _S("%F%*D de %N de %Y"); // day de month(name) de year (no leading zero in day)
...
const TUint16 RegionAspect::RegionCode = 76;
