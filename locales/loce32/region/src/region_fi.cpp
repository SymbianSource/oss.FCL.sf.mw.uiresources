...
* Contributors:
*
* Description:   elocl_reg.246 for Finland region
*
*/
...
const TInt RegionAspect::CountryCode = 358;
...
const TText* const RegionAspect::LongDateFormatSpec = _S("%F%*D%X. %Nta %Y"); // 7. syyskuuta 2001
...
const TUint16 RegionAspect::RegionCode = 246;	
