...
* Contributors:
*
* Description:   elocl_reg.191 for Croatia region
*
*/
...
const TInt RegionAspect::CountryCode = 385;
...
const TText * const RegionAspect::CurrencySymbol = _S("kn");
...
const TUint16 RegionAspect::RegionCode = 191;
