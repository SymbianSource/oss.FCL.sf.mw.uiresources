...
* Contributors:
*
* Description:   elocl_reg.348 for Hungary region
*
*/
...
const TInt RegionAspect::CountryCode = 36;
...
const TText * const RegionAspect::CurrencySymbol = _S("Ft");
const TText* const RegionAspect::ShortDateFormatSpec = _S("%F%/0%Y%/1%M%/2%D%/3"); // year/month/day (with leading zeros)
const TText* const RegionAspect::LongDateFormatSpec = _S("%F%Y. %N %D."); 
...
const TUint16 RegionAspect::RegionCode = 348;
