...
* Contributors:
*
* Description:   elocl_reg.100 for Bulgaria region
*
*/
...
const TInt RegionAspect::CountryCode = 359;
...
const TText * const RegionAspect::CurrencySymbol = _S("\x043B\x0432.");
const TText* const RegionAspect::ShortDateFormatSpec = _S("%F%/0%*D%/1%*M%/2%Y%/3"); 
const TText* const RegionAspect::LongDateFormatSpec = _S("%F%*D %N %Y \x0433."); 
...
const TUint16 RegionAspect::RegionCode = 100;
