...
* Contributors:
*
* Description:   elocl_reg.804 for Ukraine region
*
*/
...
const TInt RegionAspect::CountryCode = 380;
...
const TText * const RegionAspect::CurrencySymbol = _S("\x0433\x0440\x043D.");
const TText* const RegionAspect::ShortDateFormatSpec = _S("%F%/0%*D%/1%*M%/2%Y%/3"); // no leading zeros
const TText* const RegionAspect::LongDateFormatSpec = _S("%F%*D %N %Y \x0440."); // day month(name) year p.
...
const TUint16 RegionAspect::RegionCode = 804;
