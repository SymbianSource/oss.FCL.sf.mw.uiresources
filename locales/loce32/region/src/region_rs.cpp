...
* Contributors:
*
* Description:   elocl_reg.891 for Serbia region
*
*/
...
const TInt RegionAspect::CountryCode = 381;
...
const TText * const RegionAspect::CurrencySymbol = _S("din.");
...
const TUint16 RegionAspect::RegionCode = 891;
