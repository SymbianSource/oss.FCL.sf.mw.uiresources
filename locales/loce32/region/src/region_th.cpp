...
* Contributors:
*
* Description:   elocl_reg.764 for Thai region
*
*/
...
const TInt RegionAspect::CountryCode = 66;   
...
const TLocale::TNegativeCurrencyFormat RegionAspect::NegativeCurrencyFormat=TLocale::TNegativeCurrencyFormat(TLocale::EInBrackets); 
...
const TUint RegionAspect::WorkDays = 0x1f; // monday - friday
const TText * const RegionAspect::CurrencySymbol = _S("\x0E3F"); 
...
const TUint16 RegionAspect::RegionCode = 764;  
