...
* Contributors:
*
* Description:   elocl_reg.344 for Hong kong region
*
*/
...
const TInt RegionAspect::CountryCode = 852;
...
const TText * const RegionAspect::CurrencySymbol = _S("HK$");
...
const TText* const RegionAspect::TimeFormatSpec = _S("%F%*I:%T:%S");
...
const TUint16 RegionAspect::RegionCode = 344;
