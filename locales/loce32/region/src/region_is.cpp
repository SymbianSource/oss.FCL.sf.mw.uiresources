...
* Contributors:
*
* Description:   elocl_reg.352 for Iceland region
*
*/
...
const TInt RegionAspect::CountryCode = 354;
...
const TText* const RegionAspect::ShortDateFormatSpec = _S("%F%/0%*D%/1%*M%/2%Y%/0"); // day.month.year (no leading zeros)
...
const TUint16 RegionAspect::RegionCode = 352;
