...
* Contributors:
*
* Description:   elocl_reg.484 for Mexico region
*
*/
...
const TInt RegionAspect::CountryCode = 52;
...
const TText* const RegionAspect::LongDateFormatSpec = _S("%F%*D%X de %N de %Y"); // day de month(name) de year (no leading zero in day)
...
const TUint16 RegionAspect::RegionCode = 484;
