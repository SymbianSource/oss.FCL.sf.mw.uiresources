...
* Contributors:
*
* Description:   ELOCL.DLL for Croatia, ELOCL.45
*
*/
...
const TLanguage LLocaleData::Language = ELangCroatian;
const TInt LLocaleData::CountryCode = 385;
...
const TText * const LLocaleData::CurrencySymbol = _S("kn");
const TText* const LLocaleData::ShortDateFormatSpec = _S("%F%/0%D%/1%M%/2%Y%/3"); // day.month.year.
const TText* const LLocaleData::LongDateFormatSpec = _S("%F%D. %N %Y"); // day(dot separator) month(name) year
