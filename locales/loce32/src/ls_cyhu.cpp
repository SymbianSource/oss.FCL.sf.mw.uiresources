...
* Contributors:
*
* Description:   ELOCL.DLL for Hungary, ELOCL.17
*
*/
...
const TLanguage LLocaleData::Language = ELangHungarian;
const TInt LLocaleData::CountryCode = 36;
...
const TText * const LLocaleData::CurrencySymbol = _S("Ft");
const TText* const LLocaleData::ShortDateFormatSpec = _S("%F%/0%Y%/1%M%/2%D%/3"); // year/month/day (with leading zeros)
const TText* const LLocaleData::LongDateFormatSpec = _S("%F%Y. %N %D."); 
