...
* Contributors:
*
* Description:   ELOCL.DLL for Romania, ELOCL.78
*
*/
...
const TLanguage LLocaleData::Language = ELangRomanian;
const TInt LLocaleData::CountryCode = 40;
...
const TText* const LLocaleData::CurrencySymbol = _S("LEI");
const TText* const LLocaleData::ShortDateFormatSpec = _S("%F%/0%D%/1%M%/2%Y%/3"); // day.month.year (leading zeros)
