...
* Contributors:
*
* Description:   ELOCL.DLL for Sweden, ELOCL.06
*
*/
...
const TLanguage LLocaleData::Language = ELangSwedish;
const TInt LLocaleData::CountryCode = 46;
...
const TText* const LLocaleData::ShortDateFormatSpec = _S("%F%/0%*Y%/1%M%/2%D%/3"); // year.month,day (leading zeros, year with 2 digits)
