...
* Contributors:
*
* Description:   ELOCL.DLL for Czech, ELOCL.25
*
*/
...
const TLanguage LLocaleData::Language = ELangCzech;
const TInt LLocaleData::CountryCode = 420;
...
const TText * const LLocaleData::CurrencySymbol = _S("K\x010D");
