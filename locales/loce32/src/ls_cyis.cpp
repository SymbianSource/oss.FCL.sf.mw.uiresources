...
* Contributors:
*
* Description:   ELOCL.DLL for Iceland, ELOCL.15
*
*/
...
const TLanguage LLocaleData::Language = ELangIcelandic;
const TInt LLocaleData::CountryCode = 354;
...
const TText* const LLocaleData::ShortDateFormatSpec = _S("%F%/0%*D%/1%*M%/2%Y%/0"); // day.month.year (no leading zeros)
