...
* Contributors:
*
* Description:   ELOCL.DLL for Slovenia, ELOCL.28
*
*/
...
const TLanguage LLocaleData::Language = ELangSlovenian;
const TInt LLocaleData::CountryCode = 386;
...
const TText * const LLocaleData::CurrencySymbol = _S("SIT");
