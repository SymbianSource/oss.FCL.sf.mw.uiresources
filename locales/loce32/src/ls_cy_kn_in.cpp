...
* Contributors:
*
* Description:   ELOCL.DLL for Kannada, Epoc code 62
*
*/
...
const TLanguage LLocaleData::Language = ELangKannada;
...
const TText * const LLocaleData::CurrencySymbol = _S("\x0CB0\x0CC1");
