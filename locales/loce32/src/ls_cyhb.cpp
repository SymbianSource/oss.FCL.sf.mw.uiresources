...
* Contributors:
*
* Description:   ELOCL.DLL for Hebrew, ELOCL.57
*
*/
...
const TLanguage LLocaleData::Language = ELangHebrew;
const TInt LLocaleData::CountryCode = 972;
...
const TUint LLocaleData::WorkDays = 0x4F; // sunday - thursday
const TText * const LLocaleData::CurrencySymbol = _S("\x20AA");
const TText* const LLocaleData::ShortDateFormatSpec = _S("%F%/0%*D%/1%*M%/2%Y%/3"); // no leading zeros 4-digit year dd/mm/yyyy
const TText* const LLocaleData::LongDateFormatSpec = _S("%F%D %Y %N"); // 7 2001 xxxx
const TText* const LLocaleData::TimeFormatSpec = _S("%F%:0%H%:1%T%:2%S%:3"); // 2:01:01
