...
* Contributors:
*
* Description:   ELOCL.DLL for Galician, Epoc code 402
*
*/
...
const TLanguage LLocaleData::Language = (const enum TLanguage)KLangGalician;
...
const TText* const LLocaleData::LongDateFormatSpec = _S("%F%*D%X de %N de %Y");
