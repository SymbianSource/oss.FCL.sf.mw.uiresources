...
* Contributors:
*
* Description:   ELOCL.DLL for Finland, ELOCL.09
*
*/
...
const TLanguage LLocaleData::Language = ELangFinnish;
const TInt LLocaleData::CountryCode = 358;
...
const TText* const LLocaleData::LongDateFormatSpec = _S("%F%*D%X. %Nta %Y"); // 7. syyskuuta 2001
