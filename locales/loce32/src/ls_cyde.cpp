...
* Contributors:
*
* Description:   ELOCL.DLL for Germany, ELOCL.03
*
*/
...
const TText* const LLocaleData::ShortDateFormatSpec = _S("%F%/0%*D%/1%*M%/2%*Y%/3"); // day.month.year (with leading zeros, year with 2 digits)
