...
* Contributors:
*
* Description:   ELOCL.DLL for Latvia, ELOCL.67
*
*/
...
const TLanguage LLocaleData::Language = ELangLatvian;
const TInt LLocaleData::CountryCode = 371;
...
const TText * const LLocaleData::CurrencySymbol = _S("Ls");
const TText* const LLocaleData::ShortDateFormatSpec = _S("%F%/0%*D%/1%*M%/2%Y%/3"); // day.month.year (with leading zeros)
const TText* const LLocaleData::LongDateFormatSpec = _S("%F%Y. gada %*D. %N"); // day(dot separator) month(name) year
