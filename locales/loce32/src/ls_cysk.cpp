...
* Contributors:
*
* Description:   ELOCL.DLL for Slovakia, ELOCL.26
*
*/
...
const TLanguage LLocaleData::Language = ELangSlovak;
const TInt LLocaleData::CountryCode = 421;
...
const TText * const LLocaleData::CurrencySymbol = _S("Sk");
