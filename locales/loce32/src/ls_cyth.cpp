...
* Contributors:
*
* Description:   ELOCL.DLL for Thai, ELOCL.33
*
*/
...
const TLanguage LLocaleData::Language = ELangThai;
...
const TLocale::TNegativeCurrencyFormat LLocaleData::NegativeCurrencyFormat=TLocale::TNegativeCurrencyFormat(TLocale::EInBrackets); 
