...
* Contributors:
*
* Description:   ELOCL.DLL for Ukrania, ELOCL.93
*
*/
...
const TLanguage LLocaleData::Language = ELangUkrainian;
const TInt LLocaleData::CountryCode = 380;
...
const TText * const LLocaleData::CurrencySymbol = _S("\x0433\x0440\x043D.");
const TText* const LLocaleData::ShortDateFormatSpec = _S("%F%/0%*D%/1%*M%/2%Y%/3"); // no leading zeros
const TText* const LLocaleData::LongDateFormatSpec = _S("%F%*D %N %Y \x0440."); // day month(name) year p.
