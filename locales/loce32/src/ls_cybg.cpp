...
* Contributors:
*
* Description:   ELOCL.DLL for Bulgaria, ELOCL.42
*
*/
...
const TLanguage LLocaleData::Language = ELangBulgarian;
const TInt LLocaleData::CountryCode = 359;
...
const TText * const LLocaleData::CurrencySymbol = _S("\x043B\x0432.");
const TText* const LLocaleData::ShortDateFormatSpec = _S("%F%/0%*D%/1%*M%/2%Y%/3"); 
const TText* const LLocaleData::LongDateFormatSpec = _S("%F%*D %N %Y \x0433."); 
