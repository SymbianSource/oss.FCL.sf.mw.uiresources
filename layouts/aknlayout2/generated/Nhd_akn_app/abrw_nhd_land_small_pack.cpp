...
// Abrw_Nhd_land_Small_Pack generated by
...
_LIT(name,"Abrw_Nhd_land_Small_Pack");
...
CDL_ARRAY_START(TCdlRef, contents)
	{
	LOCAL_CDL_REF(AknLayoutScalable_Abrw_pnl_av_nhd_lsc_Small),
	LOCAL_CDL_REF(AknLayoutScalable_Abrw_pnl_apps_nhd_lsc_Small),
