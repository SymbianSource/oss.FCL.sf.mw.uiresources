...
// Abrw_Nhd_Normal_Pack generated by
...
_LIT(name,"Abrw_Nhd_Normal_Pack");
...
CDL_ARRAY_START(TCdlRef, contents)
	{
	LOCAL_CDL_REF(AknLayoutScalable_Abrw_pnp_av_nhd_prt_Normal),
	LOCAL_CDL_REF(AknLayoutScalable_Abrw_pnp_apps_nhd_prt_Normal),
