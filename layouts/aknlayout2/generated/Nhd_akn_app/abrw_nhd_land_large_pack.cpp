...
// Abrw_Nhd_land_Large_Pack generated by
...
_LIT(name,"Abrw_Nhd_land_Large_Pack");
...
CDL_ARRAY_START(TCdlRef, contents)
	{
	LOCAL_CDL_REF(AknLayoutScalable_Abrw_pnl_av_nhd_lsc_Large),
	LOCAL_CDL_REF(AknLayoutScalable_Abrw_pnl_apps_nhd_lsc_Large),
