...
// Apac_Nhd_land_Small_Pack generated by
...
_LIT(name,"Apac_Nhd_land_Small_Pack");
...
CDL_ARRAY_START(TCdlRef, contents)
	{
	LOCAL_CDL_REF(AknLayoutScalable_Elaf_pnl_av_nhd_lsc_Small),
	LOCAL_CDL_REF(AknLayoutScalable_Elaf_pnl_apps_nhd_lsc_Small),
