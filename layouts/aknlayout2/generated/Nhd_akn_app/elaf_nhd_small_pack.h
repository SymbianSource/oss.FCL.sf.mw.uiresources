...
// This header file contains the customisation implementation identity for Elaf_Nhd_Small_Pack
// It was generated by:
...
#ifndef ELAF_NHD_SMALL_PACK_H
#define ELAF_NHD_SMALL_PACK_H
#include "layoutpack.cdl.custom.h"
#include "elaf_nhd_small_pack.hrh"

namespace Elaf_Nhd_Small_Pack
{

const TInt KCdlInstanceId = _CDL_Elaf_Nhd_Small_Pack_KCdlInstanceId;
using LayoutPack::KCdlInterface;
using LayoutPack::KCdlInterfaceUidValue;
GLREF_D const LayoutPack::SCdlImpl KCdlImpl;

} // end of namespace Elaf_Nhd_Small_Pack
#endif // ELAF_NHD_SMALL_PACK_H
