...
// Apac_Nhd_land_Large_Pack generated by
...
_LIT(name,"Apac_Nhd_land_Large_Pack");
...
CDL_ARRAY_START(TCdlRef, contents)
	{
	LOCAL_CDL_REF(AknLayoutScalable_Elaf_pnl_av_nhd_lsc_Large),
	LOCAL_CDL_REF(AknLayoutScalable_Elaf_pnl_apps_nhd_lsc_Large),
