...
namespace AknLayoutScalable_Elaf_hqp_c_qvga_prt_Small
{
...
0x1cd8,	// (0x00001cd8) aalist_single_pane_g1_ParamLimits

0x1cd8,	// (0x00001cd8) aalist_single_pane_g1

0x1ce4,	// (0x00001ce4) aalist_single_pane_g2_ParamLimits

0x1ce4,	// (0x00001ce4) aalist_single_pane_g2

0x0004,

0x1ff7,	// (0x00001ff7) aalist_single_pane_g_ParamLimits

0x1ff7,	// (0x00001ff7) aalist_single_pane_g

0x1cfc,	// (0x00001cfc) aalist_single_pane_t1_ParamLimits

0x1cfc,	// (0x00001cfc) aalist_single_pane_t1

0x1d1a,	// (0x00001d1a) aalist_double_pane_g1_ParamLimits

0x1d1a,	// (0x00001d1a) aalist_double_pane_g1

0x1d26,	// (0x00001d26) aalist_double_pane_g2_ParamLimits

0x1d26,	// (0x00001d26) aalist_double_pane_g2

0x0001,

0x2002,	// (0x00002002) aalist_double_pane_g_ParamLimits

0x2002,	// (0x00002002) aalist_double_pane_g

0x1d3a,	// (0x00001d3a) aalist_double_pane_t1_ParamLimits

0x1d3a,	// (0x00001d3a) aalist_double_pane_t1

0x1d50,	// (0x00001d50) aalist_double_pane_t2_ParamLimits

0x1d50,	// (0x00001d50) aalist_double_pane_t2

0x0001,

0x2007,	// (0x00002007) aalist_double_pane_t_ParamLimits

0x2007,	// (0x00002007) aalist_double_pane_t

0x0862,	// (0x00000862) aalist_double_graphic_pane_g1_ParamLimits

0x0862,	// (0x00000862) aalist_double_graphic_pane_g1

0x1d62,	// (0x00001d62) aalist_double_graphic_pane_g2_ParamLimits

0x1d62,	// (0x00001d62) aalist_double_graphic_pane_g2

0x1d82,	// (0x00001d82) aalist_double_graphic_pane_g3_ParamLimits

0x1d82,	// (0x00001d82) aalist_double_graphic_pane_g3
...
0x200c,	// (0x0000200c) aalist_double_graphic_pane_g_ParamLimits

0x200c,	// (0x0000200c) aalist_double_graphic_pane_g

0x1d9e,	// (0x00001d9e) aalist_double_graphic_pane_t1_ParamLimits

0x1d9e,	// (0x00001d9e) aalist_double_graphic_pane_t1

0x1dbe,	// (0x00001dbe) aalist_double_graphic_pane_t2_ParamLimits

0x1dbe,	// (0x00001dbe) aalist_double_graphic_pane_t2

0x0001,

0x2023,	// (0x00002023) aalist_double_graphic_pane_t_ParamLimits

0x2023,	// (0x00002023) aalist_double_graphic_pane_t

0x1e04,	// (0x00001e04) aalist_double_entry_pane_t1

0x1e12,	// (0x00001e12) aalist_entry_pane
...
0x1e28,	// (0x00001e28) aalist_double_progress_pane_g2_ParamLimits

0x1e28,	// (0x00001e28) aalist_double_progress_pane_g2

0x1e58,	// (0x00001e58) aalist_double_progress_pane_g3_ParamLimits

0x1e58,	// (0x00001e58) aalist_double_progress_pane_g3

0x0002,

0x2028,	// (0x00002028) aalist_double_progress_pane_g_ParamLimits

0x2028,	// (0x00002028) aalist_double_progress_pane_g

0x1e88,	// (0x00001e88) aalist_double_progress_pane_t1_ParamLimits

0x1e88,	// (0x00001e88) aalist_double_progress_pane_t1

0x1eac,	// (0x00001eac) aalist_double_progress_pane_t2_ParamLimits

0x1eac,	// (0x00001eac) aalist_double_progress_pane_t2
...
0x202f,	// (0x0000202f) aalist_double_progress_pane_t_ParamLimits

0x202f,	// (0x0000202f) aalist_double_progress_pane_t

0x1ed0,	// (0x00001ed0) aalist_progress_pane_ParamLimits

0x1ed0,	// (0x00001ed0) aalist_progress_pane
...
0x1ef2,	// (0x00001ef2) aalist_list_sub_pane_g4_ParamLimits

0x1ef2,	// (0x00001ef2) aalist_list_sub_pane_g4

0x1efe,	// (0x00001efe) aalist_list_sub_pane_g5_ParamLimits

0x1efe,	// (0x00001efe) aalist_list_sub_pane_g5

0x1f2e,	// (0x00001f2e) aalist_list_sub_pane_g7_ParamLimits

0x1f2e,	// (0x00001f2e) aalist_list_sub_pane_g7

0x0005,

0x2036,	// (0x00002036) aalist_list_sub_pane_g_ParamLimits

0x2036,	// (0x00002036) aalist_list_sub_pane_g

0x1f66,	// (0x00001f66) aalist_list_sub_pane_t1_ParamLimits

0x1f66,	// (0x00001f66) aalist_list_sub_pane_t1

0x1f7b,	// (0x00001f7b) aalist_list_sub_pane_t2_ParamLimits

0x1f7b,	// (0x00001f7b) aalist_list_sub_pane_t2

0x0001,

0x2043,	// (0x00002043) aalist_list_sub_pane_t_ParamLimits

0x2043,	// (0x00002043) aalist_list_sub_pane_t
...
} // end of namespace AknLayoutScalable_Elaf_hqp_c_qvga_prt_Small
