...
namespace UiAccel_Abrw_Qvga_Large_Pack
{

_LIT(name,"UiAccel_Abrw_Qvga_Large_Pack");
...
CDL_ARRAY_START(TCdlRef, contents)
	{
	LOCAL_CDL_REF(AknLayoutScalable_Abrw_hqp_c_qvga_prt_Large),
	}
...
} // end of namespace UiAccel_Abrw_Qvga_Large_Pack
