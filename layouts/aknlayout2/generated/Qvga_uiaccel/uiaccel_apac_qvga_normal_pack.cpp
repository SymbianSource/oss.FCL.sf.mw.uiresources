...
namespace UiAccel_Apac_Qvga_Normal_Pack
{

_LIT(name,"UiAccel_Apac_Qvga_Normal_Pack");
...
CDL_ARRAY_START(TCdlRef, contents)
	{
	LOCAL_CDL_REF(AknLayoutScalable_Elaf_hqp_c_qvga_prt_Normal),
	}
...
} // end of namespace UiAccel_Apac_Qvga_Normal_Pack
