...
namespace AknLayoutScalable_Elaf_hqp_c_qvga_prt_Large
{
...
0x23ae,	// (0x000023ae) aalist_single_pane_t1_ParamLimits

0x23ae,	// (0x000023ae) aalist_single_pane_t1

0x23cc,	// (0x000023cc) aalist_double_pane_g1_ParamLimits

0x23cc,	// (0x000023cc) aalist_double_pane_g1

0x23d8,	// (0x000023d8) aalist_double_pane_g2_ParamLimits

0x23d8,	// (0x000023d8) aalist_double_pane_g2

0x0001,

0x2635,	// (0x00002635) aalist_double_pane_g_ParamLimits

0x2635,	// (0x00002635) aalist_double_pane_g

0x23ec,	// (0x000023ec) aalist_double_pane_t1_ParamLimits

0x23ec,	// (0x000023ec) aalist_double_pane_t1

0x2402,	// (0x00002402) aalist_double_pane_t2_ParamLimits

0x2402,	// (0x00002402) aalist_double_pane_t2

0x0001,

0x263a,	// (0x0000263a) aalist_double_pane_t_ParamLimits

0x263a,	// (0x0000263a) aalist_double_pane_t

0x0862,	// (0x00000862) aalist_double_graphic_pane_g1_ParamLimits

0x0862,	// (0x00000862) aalist_double_graphic_pane_g1

0x2414,	// (0x00002414) aalist_double_graphic_pane_g2_ParamLimits

0x2414,	// (0x00002414) aalist_double_graphic_pane_g2

0x2434,	// (0x00002434) aalist_double_graphic_pane_g3_ParamLimits

0x2434,	// (0x00002434) aalist_double_graphic_pane_g3
...
0x263f,	// (0x0000263f) aalist_double_graphic_pane_g_ParamLimits

0x263f,	// (0x0000263f) aalist_double_graphic_pane_g

0x2450,	// (0x00002450) aalist_double_graphic_pane_t1_ParamLimits

0x2450,	// (0x00002450) aalist_double_graphic_pane_t1

0x2470,	// (0x00002470) aalist_double_graphic_pane_t2_ParamLimits

0x2470,	// (0x00002470) aalist_double_graphic_pane_t2

0x0001,

0x2656,	// (0x00002656) aalist_double_graphic_pane_t_ParamLimits

0x2656,	// (0x00002656) aalist_double_graphic_pane_t

0x24b6,	// (0x000024b6) aalist_double_entry_pane_t1

0x24c4,	// (0x000024c4) aalist_entry_pane
...
0x24da,	// (0x000024da) aalist_double_progress_pane_g2_ParamLimits

0x24da,	// (0x000024da) aalist_double_progress_pane_g2

0x250a,	// (0x0000250a) aalist_double_progress_pane_g3_ParamLimits

0x250a,	// (0x0000250a) aalist_double_progress_pane_g3

0x0002,

0x265b,	// (0x0000265b) aalist_double_progress_pane_g_ParamLimits

0x265b,	// (0x0000265b) aalist_double_progress_pane_g

0x253a,	// (0x0000253a) aalist_double_progress_pane_t1_ParamLimits

0x253a,	// (0x0000253a) aalist_double_progress_pane_t1

0x255e,	// (0x0000255e) aalist_double_progress_pane_t2_ParamLimits

0x255e,	// (0x0000255e) aalist_double_progress_pane_t2
...
0x2662,	// (0x00002662) aalist_double_progress_pane_t_ParamLimits

0x2662,	// (0x00002662) aalist_double_progress_pane_t

0x2582,	// (0x00002582) aalist_progress_pane_ParamLimits

0x2582,	// (0x00002582) aalist_progress_pane
...
0x25a4,	// (0x000025a4) aalist_list_sub_pane_t1_ParamLimits

0x25a4,	// (0x000025a4) aalist_list_sub_pane_t1

0x25b9,	// (0x000025b9) aalist_list_sub_pane_t2_ParamLimits

0x25b9,	// (0x000025b9) aalist_list_sub_pane_t2

0x0001,

0x2669,	// (0x00002669) aalist_list_sub_pane_t_ParamLimits

0x2669,	// (0x00002669) aalist_list_sub_pane_t
...
} // end of namespace AknLayoutScalable_Elaf_hqp_c_qvga_prt_Large
