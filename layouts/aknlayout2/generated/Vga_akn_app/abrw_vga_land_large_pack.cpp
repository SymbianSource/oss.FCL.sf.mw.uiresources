...
// Abrw_Vga_land_Large_Pack generated by
...
_LIT(name,"Abrw_Vga_land_Large_Pack");
...
CDL_ARRAY_START(TCdlRef, contents)
	{
	LOCAL_CDL_REF(AknLayoutScalable_Abrw_pvl_av_vga_lsc_Large),
	LOCAL_CDL_REF(AknLayoutScalable_Abrw_pvl_apps_vga_lsc_Large),
