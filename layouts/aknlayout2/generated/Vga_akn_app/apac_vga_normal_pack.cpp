...
// Apac_Vga_Normal_Pack generated by
...
_LIT(name,"Apac_Vga_Normal_Pack");
...
CDL_ARRAY_START(TCdlRef, contents)
	{
	LOCAL_CDL_REF(AknLayoutScalable_Elaf_pvp_av_vga_prt_Normal),
	LOCAL_CDL_REF(AknLayoutScalable_Elaf_pvp_apps_vga_prt_Normal),
