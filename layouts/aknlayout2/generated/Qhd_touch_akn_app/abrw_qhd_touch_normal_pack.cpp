...
_LIT(name,"Abrw_Qhd_touch_Normal_Pack");
...
CDL_ARRAY_START(TCdlRef, contents)
	{
	LOCAL_CDL_REF(AknLayoutScalable_Abrw_php_av_qhd_prt_tch_Normal),
	LOCAL_CDL_REF(AknLayoutScalable_Abrw_php_apps_qhd_prt_tch_Normal),
