...
_LIT(name,"Elaf_Qhd_touch_land_Small_Pack");
...
CDL_ARRAY_START(TCdlRef, contents)
	{
	LOCAL_CDL_REF(AknLayoutScalable_Elaf_phl_av_qhd_lsc_tch_Small),
	LOCAL_CDL_REF(AknLayoutScalable_Elaf_phl_apps_qhd_lsc_tch_Small),
