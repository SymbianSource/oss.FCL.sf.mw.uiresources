...
_LIT(name,"Apac_Qhd_touch_Normal_Pack");
...
CDL_ARRAY_START(TCdlRef, contents)
	{
	LOCAL_CDL_REF(AknLayoutScalable_Elaf_php_av_qhd_prt_tch_Normal),
	LOCAL_CDL_REF(AknLayoutScalable_Elaf_php_apps_qhd_prt_tch_Normal),
