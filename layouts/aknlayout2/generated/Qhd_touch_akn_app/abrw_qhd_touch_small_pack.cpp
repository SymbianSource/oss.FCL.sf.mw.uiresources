...
namespace Abrw_Qhd_touch_Small_Pack
{

_LIT(name,"Abrw_Qhd_touch_Small_Pack");
...
CDL_ARRAY_START(TCdlRef, contents)
	{
	LOCAL_CDL_REF(AknLayoutScalable_Abrw_php_av_qhd_prt_tch_Small),
	LOCAL_CDL_REF(AknLayoutScalable_Abrw_php_apps_qhd_prt_tch_Small),
...
} // end of namespace Abrw_Qhd_touch_Small_Pack
