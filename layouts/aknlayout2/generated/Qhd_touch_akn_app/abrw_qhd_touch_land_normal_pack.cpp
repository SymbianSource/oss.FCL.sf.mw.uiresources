...
_LIT(name,"Abrw_Qhd_touch_land_Normal_Pack");
...
CDL_ARRAY_START(TCdlRef, contents)
	{
	LOCAL_CDL_REF(AknLayoutScalable_Abrw_phl_av_qhd_lsc_tch_Normal),
	LOCAL_CDL_REF(AknLayoutScalable_Abrw_phl_apps_qhd_lsc_tch_Normal),
