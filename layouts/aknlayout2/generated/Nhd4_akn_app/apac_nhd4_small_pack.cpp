...
_LIT(name,"Apac_Nhd4_Small_Pack");
...
CDL_ARRAY_START(TCdlRef, contents)
	{
	LOCAL_CDL_REF(AknLayoutScalable_Elaf_pnp4_av_nhd4_prt_tch_Small),
	LOCAL_CDL_REF(AknLayoutScalable_Elaf_pnp4_apps_nhd4_prt_tch_Small),
