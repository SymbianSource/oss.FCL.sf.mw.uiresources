...
_LIT(name,"Elaf_Nhd4_land_Normal_Pack");
...
CDL_ARRAY_START(TCdlRef, contents)
	{
	LOCAL_CDL_REF(AknLayoutScalable_Elaf_pnl4_av_nhd4_lsc_tch_Normal),
	LOCAL_CDL_REF(AknLayoutScalable_Elaf_pnl4_apps_nhd4_lsc_tch_Normal),
