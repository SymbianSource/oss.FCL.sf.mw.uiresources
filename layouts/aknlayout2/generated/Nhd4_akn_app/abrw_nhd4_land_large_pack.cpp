...
_LIT(name,"Abrw_Nhd4_land_Large_Pack");
...
CDL_ARRAY_START(TCdlRef, contents)
	{
	LOCAL_CDL_REF(AknLayoutScalable_Abrw_pnl4_av_nhd4_lsc_tch_Large),
	LOCAL_CDL_REF(AknLayoutScalable_Abrw_pnl4_apps_nhd4_lsc_tch_Large),
