...
_LIT(name,"Abrw_Nhd4_Normal_Pack");
...
CDL_ARRAY_START(TCdlRef, contents)
	{
	LOCAL_CDL_REF(AknLayoutScalable_Abrw_pnp4_av_nhd4_prt_tch_Normal),
	LOCAL_CDL_REF(AknLayoutScalable_Abrw_pnp4_apps_nhd4_prt_tch_Normal),
