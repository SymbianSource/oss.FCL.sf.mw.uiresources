...
_LIT(name,"Apac_Nhd4_Large_Pack");
...
CDL_ARRAY_START(TCdlRef, contents)
	{
	LOCAL_CDL_REF(AknLayoutScalable_Elaf_pnp4_av_nhd4_prt_tch_Large),
	LOCAL_CDL_REF(AknLayoutScalable_Elaf_pnp4_apps_nhd4_prt_tch_Large),
