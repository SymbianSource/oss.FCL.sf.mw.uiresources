...
// This header file contains the customisation implementation identity for Elaf_Vga_touch_Normal_Pack
// It was generated by:
...
#ifndef ELAF_VGA_TOUCH_NORMAL_PACK_H
#define ELAF_VGA_TOUCH_NORMAL_PACK_H
#include "layoutpack.cdl.custom.h"
#include "elaf_vga_touch_normal_pack.hrh"

namespace Elaf_Vga_touch_Normal_Pack
{

const TInt KCdlInstanceId = _CDL_Elaf_Vga_touch_Normal_Pack_KCdlInstanceId;
using LayoutPack::KCdlInterface;
using LayoutPack::KCdlInterfaceUidValue;
GLREF_D const LayoutPack::SCdlImpl KCdlImpl;

} // end of namespace Elaf_Vga_touch_Normal_Pack
#endif // ELAF_VGA_TOUCH_NORMAL_PACK_H
