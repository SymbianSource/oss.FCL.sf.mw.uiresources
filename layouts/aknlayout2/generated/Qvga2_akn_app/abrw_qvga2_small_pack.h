...
// This header file contains the customisation implementation identity for Abrw_Qvga2_Small_Pack
// It was generated by:
...
#ifndef ABRW_QVGA2_SMALL_PACK_H
#define ABRW_QVGA2_SMALL_PACK_H
#include "layoutpack.cdl.custom.h"
#include "abrw_qvga2_small_pack.hrh"

namespace Abrw_Qvga2_Small_Pack
{

const TInt KCdlInstanceId = _CDL_Abrw_Qvga2_Small_Pack_KCdlInstanceId;
using LayoutPack::KCdlInterface;
using LayoutPack::KCdlInterfaceUidValue;
GLREF_D const LayoutPack::SCdlImpl KCdlImpl;

} // end of namespace Abrw_Qvga2_Small_Pack
#endif // ABRW_QVGA2_SMALL_PACK_H
