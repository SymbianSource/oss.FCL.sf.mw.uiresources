...
// This header file contains the customisation implementation identity for Apac_Qvga2_Large_Pack
// It was generated by:
...
#ifndef APAC_QVGA2_LARGE_PACK_H
#define APAC_QVGA2_LARGE_PACK_H
#include "layoutpack.cdl.custom.h"
#include "apac_qvga2_large_pack.hrh"

namespace Apac_Qvga2_Large_Pack
{

const TInt KCdlInstanceId = _CDL_Apac_Qvga2_Large_Pack_KCdlInstanceId;
using LayoutPack::KCdlInterface;
using LayoutPack::KCdlInterfaceUidValue;
GLREF_D const LayoutPack::SCdlImpl KCdlImpl;

} // end of namespace Apac_Qvga2_Large_Pack
#endif // APAC_QVGA2_LARGE_PACK_H
