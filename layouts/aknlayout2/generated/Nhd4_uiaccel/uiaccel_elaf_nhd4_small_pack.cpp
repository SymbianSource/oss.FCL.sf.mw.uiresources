...
namespace UiAccel_Elaf_Nhd4_Small_Pack
{

_LIT(name,"UiAccel_Elaf_Nhd4_Small_Pack");
...
CDL_ARRAY_START(TCdlRef, contents)
	{
	LOCAL_CDL_REF(AknLayoutScalable_Elaf_hnp4_c_nhd4_prt_tch_Small),
	}
...
} // end of namespace UiAccel_Elaf_Nhd4_Small_Pack
