...
_LIT(name,"Elaf_Vga4_touch_land_Normal_Pack");
...
CDL_ARRAY_START(TCdlRef, contents)
	{
	LOCAL_CDL_REF(AknLayoutScalable_Elaf_pvl4_av_vga4_lsc_tch_Normal),
	LOCAL_CDL_REF(AknLayoutScalable_Elaf_pvl4_apps_vga4_lsc_tch_Normal),
