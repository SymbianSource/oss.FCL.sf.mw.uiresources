...
_LIT(name,"Abrw_Vga4_touch_Large_Pack");
...
CDL_ARRAY_START(TCdlRef, contents)
	{
	LOCAL_CDL_REF(AknLayoutScalable_Abrw_pvp4_av_vga4_prt_tch_Large),
	LOCAL_CDL_REF(AknLayoutScalable_Abrw_pvp4_apps_vga4_prt_tch_Large),
