...
_LIT(name,"Abrw_Vga4_touch_land_Small_Pack");
...
CDL_ARRAY_START(TCdlRef, contents)
	{
	LOCAL_CDL_REF(AknLayoutScalable_Abrw_pvl4_av_vga4_lsc_tch_Small),
	LOCAL_CDL_REF(AknLayoutScalable_Abrw_pvl4_apps_vga4_lsc_tch_Small),
