...
_LIT(name,"Abrw_Qvga_land_Large_Pack");
...
CDL_ARRAY_START(TCdlRef, contents)
	{
	LOCAL_CDL_REF(AknLayoutScalable_Abrw_pql_av_qvga_lsc_Large),
	LOCAL_CDL_REF(AknLayoutScalable_Abrw_pql_apps_qvga_lsc_Large),
