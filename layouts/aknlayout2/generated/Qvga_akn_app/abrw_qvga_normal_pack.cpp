...
_LIT(name,"Abrw_Qvga_Normal_Pack");
...
CDL_ARRAY_START(TCdlRef, contents)
	{
	LOCAL_CDL_REF(AknLayoutScalable_Abrw_pqp_av_qvga_prt_Normal),
	LOCAL_CDL_REF(AknLayoutScalable_Abrw_pqp_apps_qvga_prt_Normal),
