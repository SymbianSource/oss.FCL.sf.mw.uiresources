...
namespace Apac_Qvga_Small_Pack
{

_LIT(name,"Apac_Qvga_Small_Pack");
...
CDL_ARRAY_START(TCdlRef, contents)
	{
	LOCAL_CDL_REF(AknLayoutScalable_Elaf_pqp_av_qvga_prt_Small),
	LOCAL_CDL_REF(AknLayoutScalable_Elaf_pqp_apps_qvga_prt_Small),
...
} // end of namespace Apac_Qvga_Small_Pack
