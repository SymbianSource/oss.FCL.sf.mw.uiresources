...
_LIT(name,"Elaf_Qvga_Normal_Pack");
...
CDL_ARRAY_START(TCdlRef, contents)
	{
	LOCAL_CDL_REF(AknLayoutScalable_Elaf_pqp_av_qvga_prt_Normal),
	LOCAL_CDL_REF(AknLayoutScalable_Elaf_pqp_apps_qvga_prt_Normal),
