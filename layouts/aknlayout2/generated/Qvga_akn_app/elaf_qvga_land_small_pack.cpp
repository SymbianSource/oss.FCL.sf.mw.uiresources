...
namespace Elaf_Qvga_land_Small_Pack
{

_LIT(name,"Elaf_Qvga_land_Small_Pack");
...
CDL_ARRAY_START(TCdlRef, contents)
	{
	LOCAL_CDL_REF(AknLayoutScalable_Elaf_pql_av_qvga_lsc_Small),
	LOCAL_CDL_REF(AknLayoutScalable_Elaf_pql_apps_qvga_lsc_Small),
...
} // end of namespace Elaf_Qvga_land_Small_Pack
