...
namespace AknLayoutScalable_Abrw_hvl4_c_vga4_lsc_tch_Small
{
...
0x227f,	// (0x0000227f) aalist_single_pane_g1_ParamLimits

0x227f,	// (0x0000227f) aalist_single_pane_g1

0x228b,	// (0x0000228b) aalist_single_pane_g2_ParamLimits

0x228b,	// (0x0000228b) aalist_single_pane_g2

0x0004,

0x259e,	// (0x0000259e) aalist_single_pane_g_ParamLimits

0x259e,	// (0x0000259e) aalist_single_pane_g

0x22a3,	// (0x000022a3) aalist_single_pane_t1_ParamLimits

0x22a3,	// (0x000022a3) aalist_single_pane_t1

0x22c1,	// (0x000022c1) aalist_double_pane_g1_ParamLimits

0x22c1,	// (0x000022c1) aalist_double_pane_g1

0x22cd,	// (0x000022cd) aalist_double_pane_g2_ParamLimits

0x22cd,	// (0x000022cd) aalist_double_pane_g2

0x0001,

0x25a9,	// (0x000025a9) aalist_double_pane_g_ParamLimits

0x25a9,	// (0x000025a9) aalist_double_pane_g

0x22e1,	// (0x000022e1) aalist_double_pane_t1_ParamLimits

0x22e1,	// (0x000022e1) aalist_double_pane_t1

0x22f7,	// (0x000022f7) aalist_double_pane_t2_ParamLimits

0x22f7,	// (0x000022f7) aalist_double_pane_t2

0x0001,

0x25ae,	// (0x000025ae) aalist_double_pane_t_ParamLimits

0x25ae,	// (0x000025ae) aalist_double_pane_t

0x1758,	// (0x00001758) aalist_double_graphic_pane_g1_ParamLimits

0x1758,	// (0x00001758) aalist_double_graphic_pane_g1

0x2309,	// (0x00002309) aalist_double_graphic_pane_g2_ParamLimits

0x2309,	// (0x00002309) aalist_double_graphic_pane_g2

0x2329,	// (0x00002329) aalist_double_graphic_pane_g3_ParamLimits

0x2329,	// (0x00002329) aalist_double_graphic_pane_g3
...
0x25b3,	// (0x000025b3) aalist_double_graphic_pane_g_ParamLimits

0x25b3,	// (0x000025b3) aalist_double_graphic_pane_g

0x2345,	// (0x00002345) aalist_double_graphic_pane_t1_ParamLimits

0x2345,	// (0x00002345) aalist_double_graphic_pane_t1

0x2369,	// (0x00002369) aalist_double_graphic_pane_t2_ParamLimits

0x2369,	// (0x00002369) aalist_double_graphic_pane_t2

0x0001,

0x25ca,	// (0x000025ca) aalist_double_graphic_pane_t_ParamLimits

0x25ca,	// (0x000025ca) aalist_double_graphic_pane_t

0x23b9,	// (0x000023b9) aalist_double_entry_pane_t1

0x23c7,	// (0x000023c7) aalist_entry_pane

0x2051,	// (0x00002051) aalist_entry_pane_t1
...
0x23cf,	// (0x000023cf) aalist_double_progress_pane_g2_ParamLimits

0x23cf,	// (0x000023cf) aalist_double_progress_pane_g2

0x23ff,	// (0x000023ff) aalist_double_progress_pane_g3_ParamLimits

0x23ff,	// (0x000023ff) aalist_double_progress_pane_g3

0x0002,

0x25cf,	// (0x000025cf) aalist_double_progress_pane_g_ParamLimits

0x25cf,	// (0x000025cf) aalist_double_progress_pane_g

0x242f,	// (0x0000242f) aalist_double_progress_pane_t1_ParamLimits

0x242f,	// (0x0000242f) aalist_double_progress_pane_t1

0x2453,	// (0x00002453) aalist_double_progress_pane_t2_ParamLimits

0x2453,	// (0x00002453) aalist_double_progress_pane_t2

0x20f5,	// (0x000020f5) aalist_double_progress_pane_t3_ParamLimits

0x20f5,	// (0x000020f5) aalist_double_progress_pane_t3

0x0002,

0x25d6,	// (0x000025d6) aalist_double_progress_pane_t_ParamLimits

0x25d6,	// (0x000025d6) aalist_double_progress_pane_t

0x2477,	// (0x00002477) aalist_progress_pane_ParamLimits

0x2477,	// (0x00002477) aalist_progress_pane
...
0x1eec,	// (0x00001eec) aaslider_pane_ParamLimits

0x1eec,	// (0x00001eec) aaslider_pane
...
0x2499,	// (0x00002499) aalist_list_sub_pane_g4_ParamLimits

0x2499,	// (0x00002499) aalist_list_sub_pane_g4

0x24a5,	// (0x000024a5) aalist_list_sub_pane_g5_ParamLimits

0x24a5,	// (0x000024a5) aalist_list_sub_pane_g5

0x24d5,	// (0x000024d5) aalist_list_sub_pane_g7_ParamLimits

0x24d5,	// (0x000024d5) aalist_list_sub_pane_g7

0x0005,

0x25dd,	// (0x000025dd) aalist_list_sub_pane_g_ParamLimits

0x25dd,	// (0x000025dd) aalist_list_sub_pane_g

0x250d,	// (0x0000250d) aalist_list_sub_pane_t1_ParamLimits

0x250d,	// (0x0000250d) aalist_list_sub_pane_t1

0x2522,	// (0x00002522) aalist_list_sub_pane_t2_ParamLimits

0x2522,	// (0x00002522) aalist_list_sub_pane_t2

0x0001,

0x25ea,	// (0x000025ea) aalist_list_sub_pane_t_ParamLimits

0x25ea,	// (0x000025ea) aalist_list_sub_pane_t
...
} // end of namespace AknLayoutScalable_Abrw_hvl4_c_vga4_lsc_tch_Small
