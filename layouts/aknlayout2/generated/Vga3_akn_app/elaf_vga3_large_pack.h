...
// This header file contains the customisation implementation identity for Elaf_Vga3_Large_Pack
// It was generated by:
...
#ifndef ELAF_VGA3_LARGE_PACK_H
#define ELAF_VGA3_LARGE_PACK_H
#include "layoutpack.cdl.custom.h"
#include "elaf_vga3_large_pack.hrh"

namespace Elaf_Vga3_Large_Pack
{

const TInt KCdlInstanceId = _CDL_Elaf_Vga3_Large_Pack_KCdlInstanceId;
using LayoutPack::KCdlInterface;
using LayoutPack::KCdlInterfaceUidValue;
GLREF_D const LayoutPack::SCdlImpl KCdlImpl;

} // end of namespace Elaf_Vga3_Large_Pack
#endif // ELAF_VGA3_LARGE_PACK_H
