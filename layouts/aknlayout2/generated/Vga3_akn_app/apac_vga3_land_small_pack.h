...
// This header file contains the customisation implementation identity for Apac_Vga3_land_Small_Pack
// It was generated by:
...
#ifndef APAC_VGA3_LAND_SMALL_PACK_H
#define APAC_VGA3_LAND_SMALL_PACK_H
#include "layoutpack.cdl.custom.h"
#include "apac_vga3_land_small_pack.hrh"

namespace Apac_Vga3_land_Small_Pack
{

const TInt KCdlInstanceId = _CDL_Apac_Vga3_land_Small_Pack_KCdlInstanceId;
using LayoutPack::KCdlInterface;
using LayoutPack::KCdlInterfaceUidValue;
GLREF_D const LayoutPack::SCdlImpl KCdlImpl;

} // end of namespace Apac_Vga3_land_Small_Pack
#endif // APAC_VGA3_LAND_SMALL_PACK_H
