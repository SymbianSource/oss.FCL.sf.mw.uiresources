...
// This header file contains the customisation implementation identity for Abrw_Vga3_land_Normal_Pack
// It was generated by:
...
#ifndef ABRW_VGA3_LAND_NORMAL_PACK_H
#define ABRW_VGA3_LAND_NORMAL_PACK_H
#include "layoutpack.cdl.custom.h"
#include "abrw_vga3_land_normal_pack.hrh"

namespace Abrw_Vga3_land_Normal_Pack
{

const TInt KCdlInstanceId = _CDL_Abrw_Vga3_land_Normal_Pack_KCdlInstanceId;
using LayoutPack::KCdlInterface;
using LayoutPack::KCdlInterfaceUidValue;
GLREF_D const LayoutPack::SCdlImpl KCdlImpl;

} // end of namespace Abrw_Vga3_land_Normal_Pack
#endif // ABRW_VGA3_LAND_NORMAL_PACK_H
